        ...
        return (
            <section className="history-circles-mobile">
                ...
                {this.state.circle === 40 &&
                    <main className="display-circle-text">
                        <h3 className="history-circles-header">2014 - Amarillo pharmacy becomes Southwest distributor for production animal package goods</h3>
                        <p className="history-circles-para"></p>
                    </main>}

                {this.state.circle === 39 &&
                    <main className="display-circle-text">
                        <h3 className="history-circles-header">2015 - MWI Animal Health and Micro Technologies acquired by AmerisourceBergen</h3>
