  ...
  render() {
    return (
      <div className="moreinfo-display">
        <h4 className="moreinfo-display-header">SCR HEATIME<sup>&reg;</sup></h4>
        ...
        <div className="phone-container2">
          ...
          <div className="iphone-text-box">
            ...
            <p className="iphone-text2">The SCR<sup>&reg;</sup> cloud-based  service supports Heatime users with mobile and web applications. It enables  seamless connectivity with third-party systems and data backup capabilities.</p>
          </div>
        </div>
      </div>
    )
